  ...
  <div class="base-pic-upload">
    ...
    >
      <div v-if="hideAllBtn" class="test">
        <el-button slot="trigger" size="small" type="primary" @click="selectFiles()">选择文件</el-button>
...
export default {
  ...
  methods: {
    ...
    selectFiles() {
      this.cancal = true
      this.$emit('selectFile', this.cancal)
    },
    ...
    handleOnRemove(file, fileList) {
      this.isChanged = true
      this.$emit('rement', this.isChanged)
      this.nowFileList = fileList
    },
    hasFile() {
