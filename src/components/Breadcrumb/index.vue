    ...
    <transition-group name="breadcrumb">
      <el-breadcrumb-item v-for="(item, index) in levelList" :key="item.path">
        ...
        <!--<div class="mark" v-if="item.meta.title === '项目立项' && item.meta.title.indexOf('项目立项') >=0">
          ...
          <el-link target="_blank" :underline="false" style="padding-bottom: 12px;padding-left:3px;cursor: pointer;"
          >操作简介
          </el-link>
        </div>
        <div class="mark" v-if="item.meta.title === '项目管理'  && item.meta.title.indexOf('项目管理') >=0">
          <img src="@/icons/manageExplain.png" style="height:18px">
          <el-link target="_blank" :underline="false" style="padding-bottom: 12px;padding-left:3px;cursor: pointer;"
          >操作简介
          </el-link>
